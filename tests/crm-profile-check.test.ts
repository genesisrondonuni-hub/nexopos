...
const medical = { profileId: "MEDICAL_OFFICE" as const, businessName: "Consultorio", suggestedCategories: ["Consulta"], categories: ["Consulta", "Control"], features: { recipes: false, tables: false, barcode: false, wholesalePricing: false, delivery: false, catalog: true, ageCheck: false, weightedProducts: false, appointments: true, serviceOrders: true, variants: false, onlineSales: false }, copy: { catalogGreeting: "Hola", crmMessage: "Agenda", agentWelcome: "Orienta" } };
