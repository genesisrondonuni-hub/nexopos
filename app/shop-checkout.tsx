...
export default function ShopCheckoutScreen() {
  ...
  useEffect(() => {
    if ((!crmSettings.delivery.enabled || !configuration.features.delivery) && delivery === "Domicilio") setDelivery("Recogida");
  }, [crmSettings.delivery.enabled, configuration.features.delivery, delivery]);
