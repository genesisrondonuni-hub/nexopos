...
const styles = StyleSheet.create({
  ...
  categoriesLink: { alignItems: "center", backgroundColor: colors.white, borderColor: colors.line, borderRadius: 14, borderWidth: 1, flexDirection: "row", gap: 10, minHeight: 64, padding: 11 },
  categoryLinkIcon: { alignItems: "center", backgroundColor: colors.mint, borderRadius: 10, height: 36, justifyContent: "center", width: 36 },
  categoryLinkCopy: { flex: 1 },
  categoryLinkTitle: { color: colors.ink, fontSize: 12, fontWeight: "800" },
