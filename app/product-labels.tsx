...
export default function ProductLabelsScreen() {
  ...
  const print = async () => {
    ...
    try { await Print.printAsync({ html: createProductLabelsHtml(selectedProducts, configuration.businessName, configuration.fiscal) }); haptic.success(); }
