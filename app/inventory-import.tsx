...
export default function InventoryImportScreen() {
  ...
  const loadRows = (rows: unknown[][], name: string) => { const next = previewInventoryRows(rows); setPreview(next); setSourceName(name); haptic.medium(); };
  ...
  const applyImport = () => {
    ...
    const result = upsertImportedProducts(preview.products);
    haptic.success();
