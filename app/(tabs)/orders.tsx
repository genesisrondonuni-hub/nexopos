...
function actionLabel(current: OrderStatus, serviceFlow: boolean) { if (current === "PENDIENTE") return serviceFlow ? "Confirmar" : "Preparar"; if (current === "EN PROCESO") return serviceFlow ? "Finalizar" : "Marcar pagado"; if (current === "PAGADO") return "Archivar"; return "Archivado"; }
